...
let elementsObject = [
    ...
    new Element("Swamp", "🌴 Swamp", "nature", ["Mud", "Water"], true),
    ...
    new Element("Squirrel", "🐿️ Squirrel", "animals", ["Tree", "Life"], true),
    ...
    new Element("Ship", "🚢 Ship", "humanInnovation", ["Pirate", "Ocean"], true),
    ...
    new Element("Horror Game", "👹 Horror Game", "media", ["Video Game", "Fear"], true),
